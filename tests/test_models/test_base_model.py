...
class TestBaseModel(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        self.z.my_number = 89
        bicryt4 = self.z.to_dict()
        self.assertEqual(type(bicryt4['my_number']), int)
        self.assertEqual(type(bicryt4['name']), str)
        self.assertEqual(type(bicryt4['__class__']), str)
        self.assertEqual(bicryt4['__class__'], 'BaseModel')
        self.assertEqual(type(bicryt4['updated_at']), str)
        self.assertEqual(type(bicryt4['id']), str)
        self.assertEqual(type(bicryt4['created_at']), str)
